...
> 
> [我的的博客](https://jenesherwood-edu.github.io)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[JeneSherwood Blog](https://jenesherwood-edu.github.io)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：
[![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/readme-home.png?raw=true)](https://jenesherwood-edu.github.io/)

在手机上的布局：
[![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/post-home-h5.png?raw=true)](https://jenesherwood-edu.github.io/)
...
注册完成后搜索 `flyingwzb.github.io` 进入[我的仓库](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io)

![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-001.png?raw=true)
点击右上角的 **Fork** 将我的仓库拉倒你的账号下

稍等一下，点击刷新，你会看到**Fork**了成功的页面
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-002.png?raw=true)

### 修改仓库名

点击**settings**进入设置
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-003.png?raw=true)

<p id = "Rename"></p>
修改仓库名为 `你的Github账号名.github.io`，然后 Rename

![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-004.png?raw=true)

这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`flyingwzb.github.io`

你将会看到如下界面
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/readme-home.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-005.png?raw=true)

点击修改
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-006.png?raw=true)

然后编辑`_config.yml`的内容
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-007.png?raw=true)
...
keyword: "JeneSherwood, JeneSherwood Blog, JeneSherwood, flyingwzb, JeneSherwood, Java, golang" #关键词
url: "https://jenesherwood-edu.github.io"  # 这个就是填写你的博客地址
baseurl: ""                         # 这个我们不用填写
```
#### 侧边栏
```yaml
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](https://jenesherwood-edu.github.io/2018/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-008.png?raw=true)

创建一个文件
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-009.png?raw=true)

在下面写文章，和标题，还能实时预览，最后提交保存就能看到自己的新文章了。
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-010.png?raw=true)


## 格式
每一篇文章文件命名采用的是`2018-01-01-Hello-2018.md`时间+标题的形式，空格用`-`替换连接。

文件的格式是 `.md` 的 [**MarkDown**](https://jenesherwood-edu.github.io/2018/01/05/Markdown%E4%BD%BF%E7%94%A8/) 文件。

我们的博客文章格式采用是 **MarkDown**+ **YAML** 的方式。

[**YAML**](http://www.ruanyifeng.com/blog/2016/07/yaml.html?f=tt) 就是我们配置 `_config`文件用的语言。

[**MarkDown**](https://jenesherwood-edu.github.io/2018/01/05/Markdown%E4%BD%BF%E7%94%A8/) 是一种轻量级的「标记语言」，很简单。[花半个小时看一下](https://jenesherwood-edu.github.io/2018/01/05/Markdown%E4%BD%BF%E7%94%A8/)就能熟练使用了
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-011.png?raw=true)
...
# 自定义域名
搭建好博客之后 你可能不想直接使用 [flyingwzb.github.io](http://flyingwzb.github.io) 这么长的博客域名吧, 想换成想 [flyingd.cn](https://jenesherwood-edu.github.io) 这样简短的域名。那我们开始吧！
...
选择你注册好的域名，点击解析
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-012.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-013.png?raw=true)
...
选择 **CNAME** 文件
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-014.png?raw=true)

使用的注册的域名进行替换,然后提交保存
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-015.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-016.png?raw=true)
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io) 点个 **star** 吧！

因为最近发现 Fork 将近破百，加上直接 Clone 仓库的，保守估计已经帮助上百人成功的搭建了自己的博客，~~可是 Star 却仅仅只有 **12**！可能还是做的不够好吧！~~现在已经破百了，感谢大家的Star！

### **别无他求，点个 [Star](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io) 吧**！

![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-017.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-018.png?raw=true)

要修改如图所示的网站 **icon**：

在博客 `img` 目录下找到并替换 `favicon.ico` 这个图标即可，图标尺寸为`32x32`。
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-019.png?raw=true)
...
就是这个：
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-020.png?raw=true)

很简单，找到博客目录下的 **index.html** 文件，修改这句话就可以了。
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-021.png?raw=true)

#### 如何在博客文章中上插入图片

博客的文章用的是 MarkDown 格式，如果没用过 MarkDown 真的 强烈推荐 [花半个小时学习一下](https://jenesherwood-edu.github.io/2018/01/05/use-markdown/)。
...
![https://tinypng.com/](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-025.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-022.png?raw=true)

统计网站PV、UV统计效果如下：
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-023.png?raw=true)
...
![](https://github.com/jenesherwood-edu/jenesherwood-edu.github.io/blob/master/img/blog/blog-024.png?raw=true)
